...
import { CustomScrollbarCSS } from "../../CustomScrollbarCSS";
...
const StyledFullWidthSidebar = styled.div`
  ...
  overflow-y: scroll; /* prevent reset scroll postion when not focus to sidebar scroll */

  &:hover {
    /* scrollbar only visible when hover on FullSidebar. In drawer sidebar always visible */
    ${({ isDrawer }) => !isDrawer && CustomScrollbarCSS}
  }
`;
