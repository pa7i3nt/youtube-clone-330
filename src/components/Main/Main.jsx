...
// export default Videos, can import any name we want, so LandingPageVideos = Videos components
import {
  ...
  return (
    <StyledMain isInSearchResultsPage={isInSearchResultsPage}>
      ...
      <Switch>
        ...
        {/* original YouTube has a 'something went wrong' page
        instead of redirecting back to the homepage */}
        <Route path="*">
          <Redirect to="/" />
        </Route>
      </Switch>
