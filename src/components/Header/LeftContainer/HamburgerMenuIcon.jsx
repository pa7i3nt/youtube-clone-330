...
const HamburgerMenuIcon = () => {
  ...
  const handleHamburgerMenuClick = () => {
    // open drawer only under 1313px,
    // mobile view doesn't have a hamburger menu so it's not a concern
...
/* 
  ...
  full width side bar: 
  - default: true
  - onClick hamburger menu icon => false

  < 1313px:
  sidebar drawer:
  - default: false
  - onClick hamburger menu icon => true
*/
